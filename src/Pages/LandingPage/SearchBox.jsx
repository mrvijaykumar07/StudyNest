...
const SearchBox = () => {
  ...
  const handleSearch = () => {
    // Navigate to LibrariesPage on button click
    navigate("/libraries");
  };
      ...
      <div className="bg-white shadow-xl rounded-2xl p-4 md:w-full mt-2 ">
        ...
        <div className="flex justify-center  hover:bg-amber-700 ">
          <button
            ...
            className=" absolute bottom-0  mt-4 bg-orange-500 text-white font-medium py-3 px-12 rounded-full shadow transition duration-200" onClick={handleSearch}
          >
            Search
          </button>
        </div>
