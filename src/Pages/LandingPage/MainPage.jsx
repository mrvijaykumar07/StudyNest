    ...
    <picture>
      ...
      <div className="md:w-[950px] md:h-[800px] px-7  md:left-0   md:relative bg-white    md:rounded-r-full ">
        ...
        <div className=" flex items-center justify-center md:justify-start gap-4">
          <button className= "  bg-blue-950 text-white px-6  md:px-10 py-3 rounded-full shadow hover:bg-amber-700 hover:text-blue-950 transition">
            Learn more
          </button>

          <button className="  flex items-center gap-2 text-blue-950 md:px-6 px-5 py-3 rounded-lg hover:bg-blue-50 transition">
            Try it out{" "}
